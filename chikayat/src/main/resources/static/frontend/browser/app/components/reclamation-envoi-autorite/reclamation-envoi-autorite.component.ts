...
export class ReclamationEnvoiAutoriteComponent implements OnInit {
  ...
  openModal(rec: any): void {
    ...
    // Par exemple, avec jQuery : $('#envoiAutoriteModal').modal('show');
  }
  ...
  submitEnvoi(): void {
    ...
    const payload = {
      voieEnvoiAutoriteId: this.selectedVoieId,
  ...
  // Charge les réclamations dont flag_envoi_autorite est 0 ou null
